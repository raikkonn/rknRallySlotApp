...
public partial class FormPrueba : Form
{
    ...
    public int? IdSelected = null;  // ID del rally seleccionado (null si es un nuevo registro)
    ...
    private void BotonSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (IdSelected.HasValue) // Si tenemos un ID, estamos en MODO EDICION
            {
                ...
                // pruebaActual.IdCampeonato = idCampeonatoActual; Es EDICION, no se puede cambiar el campeonato de una prueba ya creada
